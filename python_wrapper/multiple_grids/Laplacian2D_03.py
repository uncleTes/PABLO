            ...
            for face in xrange(0, nfaces):
                if self.__octree.get_bound(py_oct, 
                    ...
                    if not grid:
                        ...
                        boundary_value = self.evaluate_boundary_condition((x_center,
                                                                           y_center))
                    ...
                    # Grids not of the background: equal to number >= 1.
                        ...
                        not_boundary = check_point_into_square_2D(center             ,
                                                                  self.__b_boundaries,
                                                                  self.logger        ,
                                                                  log_file)
                        if not_boundary:
    ...
    def init_mat(self):
        ...
        for octant in xrange(0, local_nocts):
            ...
            if not grid:
                ...
                #if penalization:
                # "boundaries_to_check" is a new vector of vector which 
                ...
                for boundary in p_boundaries:
                    ...
                    for index, point in enumerate(boundary):
                        if (index % 2 ) == 0:
                            boundary_to_check.append(point + overlap)
                        else:
                            boundary_to_check.append(point - overlap)
        ...
        for index, dictionary in enumerate(self.__residual_global):
            for center, solution_value in dictionary.items():
                ...
                if global_idx in ids_octree_contained:
                    ...
                    #value = self.__solution.getValue(global_idx) - solution_value
...
def main():
    ...
    for i in xrange(0, 10):
        ...
        if comm_w.Get_rank() == 1:
            h= laplacian.h
            #print(laplacian._Laplacian2D__residual_global)
